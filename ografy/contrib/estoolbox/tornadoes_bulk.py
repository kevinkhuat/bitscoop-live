...
class ESBulkConnection(ESConnection):
    ...
    def bulk_unique_post(self, index, type, document_list, id_list, body=None, parameters=None, callback=None):
        ...
        for document in present_documents:
            existing_ografy_unique_id = document['_source']['ografy_unique_id']
            existing_id = document['_id']

            existing_documents_dict[existing_ografy_unique_id] = existing_id
        ...
        for document in document_list:
            ...
            if document['ografy_unique_id'] in existing_documents_keys:
                action_and_metadata['index']['_id'] = existing_documents_dict[document['ografy_unique_id']]
