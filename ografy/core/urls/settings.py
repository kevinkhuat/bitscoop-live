...
urlpatterns = patterns('',
    url(r'^settings/?$', settings_views.AccountView.as_view(), name='core_settings_account'),
    url(r'^settings/account$', settings_views.AccountView.as_view(), name='core_settings_account'),
