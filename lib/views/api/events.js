...
const orderedMap = require('explorer/lib/util/ordered-map');
const tag = require('explorer/lib/views/api/templates/tag');
const baseUrl = require('explorer/lib/util/get-base-url.js')();
