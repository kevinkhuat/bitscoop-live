...
const amalgamateTags = require('explorer/lib/util/amalgamate-tags');
...
function mongoElasticInsert(objects) {
	...
	return Promise.all([
		...
		tagsUpsert,
		thingsUpsert
	]).spread(function(hydratedContacts, hydratedContent, hydratedLocations, hydratedTags, hydratedThings) {
